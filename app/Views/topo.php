<header class="bg-dark">
    <div class="container">
        <nav class="navbar navbar-expand=sm navbar-dark">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toglle navigation">
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <a class="btn btn-info" href="#" data-tooltip="tooltip" title="Tem uma conta? Faça o Login"> Login</a>
    </span>
</div>
        </nav>
    </div>
